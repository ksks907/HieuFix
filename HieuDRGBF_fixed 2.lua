https://discord.gg/MRQfEUQtN9


shared.LoaderTitle = "do teamNHD phát triển";
...
function TweenObject(v178, v179, v180)
    game:GetService("TweenService"):Create(v178, TweenInfo.new(v179, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), v180):Play();
end
...
function CheckLevel()
    local SelectMonster, Ms, NameQuest, QuestLv, NameMon, CFrameQ, CFrameMon
    ...
    if Sea1 then
        ...
        elseif ((v197 >= 10 and v197 <= 474) or (SelectMonster == "God's Guard")) then
            Ms = "God's Guard";
        ...
        elseif ((v197 >= 525 and v197 <= 549) or (SelectMonster == "Royal Squad")) then
            Ms = "Royal Squad";
        ...
        elseif ((v197 >= 550 and v197 <= 624) or (SelectMonster == "Royal Soldier")) then
            Ms = "Royal Soldier";
            NameQuest = "SkyExp2Quest";
            QuestLv = 2;
        ...
        elseif ((v197 >= 625 and v197 <= 649) or (SelectMonster == "Galley Pirate")) then
            Ms = "Galley Pirate";
    ...
    if Sea2 then
        if ((v197 >= 700 and v197 <= 724) or (SelectMonster == "Raider")) then
            Ms = "Raider";
        ...
        elseif ((v197 >= 725 and v197 <= 774) or (SelectMonster == "Mercenary")) then
            Ms = "Mercenary";
            NameQuest = "Area1Quest";
            QuestLv = 2;
            NameMon = "Mercenary";
        ...
        elseif ((v197 >= 775 and v197 <= 799) or (SelectMonster == "Swan Pirate")) then
            Ms = "Swan Pirate";
        ...
        elseif ((v197 >= 800 and v197 <= 874) or (SelectMonster == "Factory Staff")) then
            Ms = "Factory Staff";
            NameQuest = "Area2Quest";
            QuestLv = 2;
        ...
        elseif ((v197 >= 875 and v197 <= 899) or (SelectMonster == "Marine Lieutenan")) then
        ...
        elseif ((v197 >= 900 and v197 <= 949) or (SelectMonster == "Marine Captain")) then
            Ms = "Marine Captain";
            NameQuest = "MarineQuest3";
            QuestLv = 2;
        ...
        elseif ((v197 >= 950 and v197 <= 974) or (SelectMonster == "Zombie")) then
            Ms = "Zombie";
        ...
        elseif ((v197 >= 975 and v197 <= 999) or (SelectMonster == "Vampire")) then
            Ms = "Vampire";
            NameQuest = "ZombieQuest";
            QuestLv = 2;
            NameMon = "Vampire";
        ...
        elseif ((v197 >= 1000 and v197 <= 1049) or (SelectMonster == "Snow Trooper")) then
            Ms = "Snow Trooper";
        ...
        elseif ((v197 >= 1050 and v197 <= 1099) or (SelectMonster == "Winter Warrior")) then
            Ms = "Winter Warrior";
            NameQuest = "SnowMountainQuest";
            QuestLv = 2;
        ...
        elseif ((v197 >= 1100 and v197 <= 1124) or (SelectMonster == "Lab Subordinate")) then
            Ms = "Lab Subordinate";
        ...
        elseif ((v197 >= 1125 and v197 <= 1174) or (SelectMonster == "Horned Warrior")) then
            Ms = "Horned Warrior";
            NameQuest = "IceSideQuest";
            QuestLv = 2;
        ...
        elseif ((v197 >= 1175 and v197 <= 1199) or (SelectMonster == "Magma Ninja")) then
            Ms = "Magma Ninja";
        ...
        elseif ((v197 >= 1200 and v197 <= 1249) or (SelectMonster == "Lava Pirate")) then
            Ms = "Lava Pirate";
            NameQuest = "FireSideQuest";
            QuestLv = 2;
            NameMon = "Lava Pirate";
        ...
        elseif ((v197 >= 1250 and v197 <= 1274) or (SelectMonster == "Ship Deckhand")) then
            Ms = "Ship Deckhand";
        ...
        elseif ((v197 >= 1275 and v197 <= 1299) or (SelectMonster == "Ship Engineer")) then
            Ms = "Ship Engineer";
            NameQuest = "ShipQuest1";
            QuestLv = 2;
        ...
        elseif ((v197 >= 1300 and v197 <= 1324) or (SelectMonster == "Ship Steward")) then
            Ms = "Ship Steward";
        ...
        elseif ((v197 >= 1325 and v197 <= 1349) or (SelectMonster == "Ship Officer")) then
            Ms = "Ship Officer";
            NameQuest = "ShipQuest2";
            QuestLv = 2;
        ...
        elseif ((v197 >= 1350 and v197 <= 1374) or (SelectMonster == "Arctic Warrior")) then
            Ms = "Arctic Warrior";
        ...
        elseif ((v197 >= 1375 and v197 <= 1424) or (SelectMonster == "Snow Lurker")) then
            Ms = "Snow Lurker";
            NameQuest = "FrostQuest";
            QuestLv = 2;
            NameMon = "Snow Lurker";
        ...
        elseif ((v197 >= 1425 and v197 <= 1449) or (SelectMonster == "Sea Soldier")) then
            Ms = "Sea Soldier";
    ...
    if Sea3 then
        if ((v197 >= 1500 and v197 <= 1524) or (SelectMonster == "Pirate Millionaire")) then
        ...
        elseif ((v197 >= 1525 and v197 <= 1574) or (SelectMonster == "Pistol Billionaire")) then
        ...
        elseif ((v197 >= 1575 and v197 <= 1599) or (SelectMonster == "Dragon Crew Warrior")) then
        ...
        elseif ((v197 >= 1600 and v197 <= 1624) or (SelectMonster == "Dragon Crew Archer")) then
        ...
        elseif ((v197 >= 1625 and v197 <= 1649) or (SelectMonster == "Hydra Enforcer")) then
            Ms = "Hydra Enforcer";
        ...
        elseif ((v197 >= 1650 and v197 <= 1699) or (SelectMonster == "Venomous Assailant")) then
        ...
        elseif ((v197 >= 1700 and v197 <= 1724) or (SelectMonster == "Marine Commodore")) then
            Ms = "Marine Commodore";
        ...
        elseif ((v197 >= 1725 and v197 <= 1774) or (SelectMonster == "Marine Rear Admiral")) then
        ...
        elseif ((v197 >= 1775 and v197 <= 1799) or (SelectMonster == "Fishman Raider")) then
            Ms = "Fishman Raider";
        ...
        elseif ((v197 >= 1800 and v197 <= 1824) or (SelectMonster == "Fishman Captain")) then
            Ms = "Fishman Captain";
            NameQuest = "DeepForestIsland3";
            QuestLv = 2;
        ...
        elseif ((v197 >= 1825 and v197 <= 1849) or (SelectMonster == "Forest Pirate")) then
            Ms = "Forest Pirate";
        ...
        elseif ((v197 >= 1850 and v197 <= 1899) or (SelectMonster == "Mythological Pirate")) then
        ...
        elseif ((v197 >= 1900 and v197 <= 1924) or (SelectMonster == "Jungle Pirate")) then
            Ms = "Jungle Pirate";
        ...
        elseif ((v197 >= 1925 and v197 <= 1974) or (SelectMonster == "Musketeer Pirate")) then
            Ms = "Musketeer Pirate";
            NameQuest = "DeepForestIsland2";
            QuestLv = 2;
        ...
        elseif ((v197 >= 1975 and v197 <= 1999) or (SelectMonster == "Reborn Skeleton")) then
            Ms = "Reborn Skeleton";
        ...
        elseif ((v197 >= 2000 and v197 <= 2024) or (SelectMonster == "Living Zombie")) then
            Ms = "Living Zombie";
            NameQuest = "HauntedQuest1";
            QuestLv = 2;
        ...
        elseif ((v197 >= 2100 and v197 <= 2124) or (SelectMonster == "Peanut President")) then
            Ms = "Peanut President";
            NameQuest = "NutsIslandQuest";
            QuestLv = 2;
            ...
            CFrameQ = CFrame.new(- 2105.53198, 37.2495995, - 10195.5088, - 0.766061664, 0, - 0.642767608, 0, 1, 0, 0.642767608, 0, - 0.766061664);
            CFrameMon = CFrame.new(- 2150.587890625, 122.49767303467, - 10358.994140625);
        elseif ((v197 >= 2125 and v197 <= 2149) or (SelectMonster == "Ice Cream Chef")) then
            Ms = "Ice Cream Chef";
        ...
        elseif ((v197 >= 2150 and v197 <= 2199) or (SelectMonster == "Ice Cream Commander")) then
        ...
        elseif ((v197 >= 2500 and v197 <= 2524) or (SelectMonster == "Sun-kissed Warrior")) then
            ...
            CFrameMon = CFrame.new(- 16357.3125, 20.632822036743164, 1005.64892578125);
        elseif ((v197 >= 2525 and v197 <= 2549) or (SelectMonster == "Isle Champion")) then
            Ms = "Isle Champion";
            NameQuest = "TikiQuest2";
            QuestLv = 2;
        ...
        elseif ((v197 >= 2550 and v197 <= 2574) or (SelectMonster == "Serpent Hunter")) then
            Ms = "Serpent Hunter";
        ...
        elseif ((v197 >= 2575 and v197 <= 2599) or (SelectMonster == "Skull Slayer") or (v197 == 2600)) then
            Ms = "Skull Slayer";
            NameQuest = "TikiQuest3";
            QuestLv = 2;
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=121500641013596";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/MRQfEUQtN9");
    end
});
